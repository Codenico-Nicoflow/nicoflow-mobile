...
export const calendarExtensionsEn = {
  ...
  weekView: 'Week',
  dayView: 'Day',
  editSchedule: 'Edit schedule for {{title}}',
  scheduleDateLabel: 'Scheduled date',
  scheduleTimeLabel: 'Scheduled time (HH:MM)',
  invalidSchedule: 'Enter a real date, a time from 00:00 to 23:59, and a duration from 1 to 1440 minutes.',
  allDay: 'All day',
  allDayTasks: 'All-day and unscheduled',
  noAllDayTasks: 'No all-day tasks',
  untimedTask: 'No time set',
...
export const calendarExtensionsHe = {
  ...
  nextMonth: 'החודש הבא',
  previousPeriod: '{{period}} הקודם',
  nextPeriod: '{{period}} הבא',
  monthView: 'חודש',
  weekView: 'שבוע',
  dayView: 'יום',
  editSchedule: 'עריכת התזמון של {{title}}',
  scheduleDateLabel: 'תאריך מתוזמן',
  scheduleTimeLabel: 'שעה מתוזמנת (HH:MM)',
  invalidSchedule: 'הזינו תאריך תקין, שעה בין 00:00 ל-23:59 ומשך בין 1 ל-1440 דקות.',
  allDay: 'כל היום',
  allDayTasks: 'משימות לכל היום וללא שעה',
  noAllDayTasks: 'אין משימות לכל היום',
  untimedTask: 'לא הוגדרה שעה',
...
export const calendarExtensionsRu = {
  ...
  previousPeriod: 'Предыдущий период: {{period}}',
  nextPeriod: 'Следующий период: {{period}}',
  monthView: 'Месяц',
  weekView: 'Неделя',
  dayView: 'День',
  editSchedule: 'Изменить расписание: {{title}}',
  scheduleDateLabel: 'Запланированная дата',
  scheduleTimeLabel: 'Запланированное время (HH:MM)',
  invalidSchedule: 'Введите верную дату, время от 00:00 до 23:59 и длительность от 1 до 1440 минут.',
  allDay: 'Весь день',
  allDayTasks: 'На весь день и без времени',
  noAllDayTasks: 'Нет задач на весь день',
  untimedTask: 'Время не указано',
  ...
  scheduledOn: 'Запланировано на {{date}}',
